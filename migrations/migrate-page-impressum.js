/**
 * Idempotent migration: seed localized `title` for `geko-page-impressum` (en, fr, ro, tr, ar).
 * `content` blocks are non-localized in schema — shared from DE; not sent here.
 *
 * Run: node migrate-page-impressum.js
 */
import { createStrapiClient } from './lib/strapi-client.js';

const ENDPOINT = '/api/geko-page-impressum';
...
async function migrate() {
  console.log('=== Migrate geko-page-impressum ===\n');
